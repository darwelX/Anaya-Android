...
public class ShowJob extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (startingIntent != null) { 
            Log.i("CH18::ShowJob", "starting intent not null");
            Bundle b = startingIntent.getExtras();
            if (b == null) {
                Log.i("CH18::ShowJob", "bad bundle");
                details = "bad bundle?";
            } else {
                this.je = JobEntry.fromBundle(b);
                sb.append(this.getString(R.string.jobid)+ ": " + this.je.get_jobid() + " (" + this.je.get_status() + ")\n\n");
                sb.append(this.je.get_customer() + "\n\n");
                sb.append(this.je.get_address() + "\n" + this.je.get_city() + "," + this.je.get_state() + "\n");
                sb.append(this.getString(R.string.product) + ": " + this.je.get_product() + "\n\n");
                sb.append(this.getString(R.string.comments) + ": " + this.je.get_comments() + "\n\n");
                details = sb.toString();
            }
        } else {
            details = this.getString(R.string.job_info_not_found);
        ...
        bmap.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Log.d("CH18", "error launching map? " + ee.getMessage());
                }
        ...
        bproductinfo.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Log.d("CH18", "error launching product info? " + ee.getMessage());
                }
            }
        });
        ...
        if (this.je.get_status().equals("CLOSED")) {
            bclose.setText(this.getString(R.string.view_signature));
        }
        ...
        Log.d("CH18", "Job status is :" + this.je.get_status());
