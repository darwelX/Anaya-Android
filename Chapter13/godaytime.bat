...
rem C:\software\google\android-sdk-windows-1.0_r1\tools\adb push daytime /data/ch13
rem C:\software\google\android-sdk-windows-1.0_r1\tools\adb shell "chmod 777 /data/ch13/daytime"
